    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="profile-area">
                <div class="top">
                    <div class="user"><img
                            src="<?php echo buildImagePath($view_requested_user['image_name'], 'user');?>" alt="">
                    </div>
                            ...
                            <div class="modal-content">
                                <form action="profile.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="text" name="nickname" class="form-control mb-4"
                                        ...
                                        <input type="email" name="email" class="form-control mb-4"
                                            ...
                                            placeholder="メールアドレス" maxlength="50" required>
                ...
                <div class="follow-follower">
                    <div class="follow-count"><?php echo htmlspecialchars($view_requested_user['follow_user_count']); ?>
                    </div>
                    <div class="follow-text">フォロー中</div>
                    <div class="follow-count">
                        <?php echo htmlspecialchars($view_requested_user['followed_user_count']); ?></div>
