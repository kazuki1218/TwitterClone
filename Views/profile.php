...
$view_tweets = [
    [
        ...
        'tweet_created_at' => '2021-07-28 14:00:00',
        'like_id' => null,
        'like_count' => 0,
    ],
];
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="profile-area">
                <div class="top">
                    <div class="user"><img src="<?php echo HOME_URL;?>Views/img_uploaded/user/sample-person.jpg" alt="">
                    </div>
                            ...
                            <div class="modal-content">
                                <form action="profile.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="user">
                                            <img src="<?php echo HOME_URL;?>Views/img_uploaded/user/sample-person.jpg"
                                                alt="">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <input type="text" name="nickname" class="form-control mb-4" value="太郎"
                                            placeholder="ニックネーム" maxlength="50" required autofoucs>
                                        <input type="text" name="name" class="form-control mb-4" value="taro"
                                            placeholder="ユーザー名" maxlength="50" required>
                                        <input type="email" name="email" class="form-control mb-4"
                                            value="taro@techis.jp" placeholder="メールアドレス" maxlength="50" required>
